...
urlpatterns = [
    ...
    path('orders/approved_orders/', views.ApprovedOrderListView.as_view(), name='approved_orders'),
    path('orders/assigned_orders/', views.AssignedOrderListView.as_view(), name='assigned_orders'),
    path('orders/assign_courier/', views.CourierAssignmentView.as_view(), name='assign_courier'),
