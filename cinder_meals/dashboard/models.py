...
class Order(models.Model):
    ...
    user = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='orders_user')
    ...
    phone = models.CharField(max_length=20)
    courier = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='orders_courier')
...
class Delivery(models.Model):
    name = models.CharField(max_length=200, default='Delivery')
